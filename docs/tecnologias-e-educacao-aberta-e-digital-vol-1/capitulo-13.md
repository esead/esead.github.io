...
O setor agropecuário, de suma importância para a economia brasileira e
...
Assim, dedicam-se os estudos sobre as instituições públicas e privadas
...
Com o constante monitoramento e diagnose das lavouras ao utilizar
...
Nesse intuito, as políticas públicas setoriais somam esforços a essas
...
CASTRO, F. ***Google* lança nova ferramenta de busca para dados científicos.** 2019. Disponível em:
...
FREIRE, J. R. S.; SANTOS, I. C.; BISCOLA, P.H. N. **Inovação aberta na geração do conhecimento em pesquisa e desenvolvimento na agropecuária brasileira.** 2016. Disponível em:
...
UAGRO. **Veja os aplicativos rurais que auxiliam agricultores.**
Tecnologia e Manejo. 2016. Disponível em:
http://ruralpecuaria.com.br/tecnologia-e-manejo/novas-tecnologias/veja-os-aplicativos-rurais-que-auxiliam-agricultores.html.
Acesso: 10 jan. 2019.
...
|Contribuição tecnológica |Descrição |Unidade de pesquisa e Endereço para acesso |
|---	|---	|---	|
|Uzum | Sistema especialista para diagnóstico de doenças, pragas e distúrbios fisiológicos em videiras, sendo composto por imagens e respostas úteis ao rápido diagnóstico inicial de doenças, pragas e distúrbios nutricionais. | Embrapa Uva e Vinho (Bento Gonçalves -- RS) http://www.cnpuv.embrapa.br/tecnologias/uzum/ | 
|Campo em alerta | Programa de rádio que leva informação ao produtor através de rádios parceiras e chama a atenção para o controle de pragas e doenças. | Embrapa Trigo (Passo Fundo -- RS) http://ainfo.cnptia.embrapa.br/digital/bitstream/item/124361/1/FD-0354.pdf | 
|WikiPragas | Banco de dados sobre pragas quarentenárias associadas às culturas relevantes para o agronegócio brasileiro e para a defesa fitossanitária no país. | Embrapa Informática Agropecuária (Campinas -- SP) http://ainfo.cnptia.embrapa.br/digital/bitstream/item/56787/1/alarcon.pdf | 
|WebAgritec | Sistema com a finalidade de auxiliar os profissionais ligados ao setor agropecuário na tomada de decisões a respeito das doenças e deficiências nutricionais, que porventura possam aparecer no decorrer da safra. | Embrapa Informática Agropecuária (Campinas -- SP) http://spm.embrapa.br/noticias/noticia_completa/81/ | 
|Hortaliças na Web | Sistema que contém informações específicas sobre as 50 hortaliças mais consumidas no Brasil, como origem, valor nutritivo. | Embrapa Hortaliças (Gama -- DF) http://www.cnph.embrapa.br/hortalicasnaweb/ | 
|InfoPraga | Sistema com informações sobre pragas presentes no Brasil, onde são apresentadas informações acerca da taxonomia, potenciais hospedeiros e referências bibliográficas relativas à ocorrência no país.| Embrapa Recursos Genéticos e Biotecnologia (Brasília -- DF) http://infopraga.cenargen.embrapa.br/index.htm | 
|SISALERT | Ferramenta de previsão de risco de epidemias de doenças de plantas, que auxilia a prever risco de doenças em plantas cultivadas. | Embrapa Trigo (Passo Fundo -- RS) https://www.embrapa.br/busca-de-noticias/-/noticia/18054780/sisalert--ferramenta-auxilia-prever-risco-de-doencas-em-plantas | 
|Guia InNat | Aplicativo com imagens de agentes naturais de controle de pragas agrícolas, e informações sobre predadores e parasitoides, as características morfológicas das principais famílias, o ciclo de vida e a função dos artrópodes como controladores de pragas. Ainda, permite que o usuário compare uma foto de inseto tirada com a câmera do celular com as imagens da galeria do Guia para o reconhecimento de inimigos naturais de pragas agrícolas. | Embrapa Agrobiologia (Seropédica -- RJ) https://play.google.com/store/apps/details?id=br.embrapa.innat | 
|Pasto Certo | Aplicativo que permite o acesso, de forma rápida e integrada, às características das principais cultivares de forrageiras tropicais lançadas pela Embrapa e outras cultivares de domínio público. A partir desse aplicativo é possível identificar/diferenciar as cultivares e se informar sobre as principais recomendações de uso e restrições de cada cultivar. | Embrapa Gado de Corte (Campo Grande -- MS) https://play.google.com/store/apps/details id=br.embrapa.pastocerto | 
|Radar da Tecnologia - Soja | Sítio de conteúdo multimídia, com foco em assuntos técnicos ligados à produção de soja. Reúne conhecimento científico aplicado ao dia a dia do produtor, e oferece oportunidade de aprendizado on-line, com palestras, publicações, artigos e entrevistas. | Embrapa Soja (Londrina -- PR) http://www.embrapa.br/soja/radar| 
|SimpMamão - Sistema Integrado de Monitoramento de Pragas do Mamão | Dispositivo móvel, que por meio do celular ou _tablet_, o produtor preenche planilhas digitais com informações sobre a lavoura, como número de insetos encontrados e quantidade de frutos. Após a sincronização desses dados com o sistema na internet, o SimpMamão analisa e apresenta recomendações sobre a necessidade de pulverização ou não da plantação. | Embrapa Mandioca e Fruticultura (Cruz das Almas -- BA) https://simpmamao.cnpmf.embrapa.br/#/ | 
|Diagnose Virtual | _Software_ que realiza o diagnóstico de doenças _on-line_. Possui uma infraestrutura única na área de sanidade para diagnóstico de doenças de plantas via internet, a fim de subsidiar os produtores rurais, agrônomos e técnicos agrícolas em suas decisões sobre o manejo de pragas e doenças. Ainda, visa possibilitar o uso racional de agrotóxicos, o que ajuda a evitar danos à saúde e ao meio ambiente, além de reduzir os custos da produção. | Embrapa Informática AGropecuária (Campinas -- SP) http://www.diagnose.cnptia.embrapa.br/diagnose/ | 
|Repostiório de Informação Tecnológica da Embrapa - Infoteca-e | Repositório _on-line_ que reúne e permite acesso acervo digital sobre tecnologias produzidas pela Embrapa. As coleções são formadas por publicações, áudios e vídeos sobre as mais diversas áreas de atuação da instituição. | Embrapa Sede (Brasília -- DF) https://www.infoteca.cnptia embrapa.br/ | 
...
|Desenvolvedor |Contribuição tecnológica |Descrição |Endereço para acesso|
|---	|---	|---	|---	|
|BASF | Digilab Mobile | Aplicativo para produtores rurais capturarem imagens de potenciais pragas doenças e plantas daninhas a partir de _smartphones_, e compará-las às imagens existentes no banco de dados. O objetivo é fornecer respostas mais rápidas para diagnósticos nas propriedades rurais, além de facilitar a tomada de decisão quanto à aplicação dos agroquímicos. | http://www.mexidodeideias.com.br/industria/aplicativo-para-smartphone-ajuda-no-diagnostico-de-pragas/ | 
Bayer CropScience | FOXBayer | Aplicativo que facilita a identificação de doenças de soja, trigo, algodão e feijão. Em soma, concede instruções sobre tratamento, e apresenta um banco de fotos de doenças para as quais os produtos dessa companhia têm registro. | https://apkpure.com/br/fox-bayer/phycom.fox | 
